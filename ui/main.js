...
//                'tabFn':'M.qruqsp_ntst_main.net.switchFocus(\'callsign\');',
    ...
    this.net.cellValue = function(s, i, j, d) {
        ...
        if( s == 'participants' ) {
            switch(j) {
                ...
                case 2: return '<button onclick="M.qruqsp_ntst_main.net.newMessage(' + d.id + ');">New Message</button>'
        ...
        if( s == 'messages' ) {
            switch(j) {
                ...
                case 3: return '<button onclick="M.qruqsp_ntst_main.net.resentMessage(' + d.id + ');">Resend</button>';
            }
        }
    }
    ...
    this.net.liveSearchResultRowFn = function(s, f, i, j, d) {
        return 'M.qruqsp_ntst_main.net.addSearchParticipant(\'' + escape(d.callsign) + '\',\'' + escape(d.name) + '\',\'' + escape(d.email) + '\');';
    }
