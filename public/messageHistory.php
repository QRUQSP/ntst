...
// -------
//
function qruqsp_ntst_messageHistory($ciniki) {
    //
    ...
    $rc = qruqsp_ntst_checkAccess($ciniki, $args['tnid'], 'qruqsp.ntst.messageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'qruqsp.ntst', 'qruqsp_ntst_history', $args['tnid'], 'qruqsp_ntst_messages', $args['message_id'], $args['field']);
}
?>
